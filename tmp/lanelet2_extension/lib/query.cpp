...
// lanelet::ConstPolygons3d query::getAllGnssAvailableArea(const lanelet::LaneletMapConstPtr & lanelet_map_ptr)
// {
//   lanelet::ConstPolygons3d gnss_avalilable_area_markings;
//   for (const auto & ls : lanelet_map_ptr->polygonLayer) {
//     const std::string type = ls.attributeOr(lanelet::AttributeName::Type, "none");
//     if (type.compare("gnss_available_area") == 0) {
//       gnss_avalilable_area_markings.push_back(ls);
//     }
//   }
